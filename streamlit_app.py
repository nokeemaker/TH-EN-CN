...
if user_api := st.text_input("Your API key: ", type="password"):
    ...
    if submitted:
        prompt = """The input needs to be in Thai, English or Chinese.
                ...
                translations of the other languages. The columns 5 and 6 give sentence examples in each language according to the number of the extracted words (unlike those five below!). 
